...
class AlgLibrary {
  ...
  static const List<AlgCase> ollCases = [
    ...
    AlgCase(
      ...
      description: 'H-Pattern: All 4 corners face sideways (Headlights front and back).',
    ),
    AlgCase(
      id: 'oll22',
      name: 'OLL 22 (Pi)',
    ...
    AlgCase(
      ...
      description: 'U-Pattern: Rotate the top layer until the two "headlights" face you (Front).',
    ),
    AlgCase(
      id: 'oll24',
      name: 'OLL 24 (T)',
    ...
    AlgCase(
      ...
      description: 'L-Pattern: Also called "Bowtie". Two adjacent corners face sideways.',
    ),
    AlgCase(
      id: 'oll26',
      name: 'OLL 26 (Sune)',
      ...
      description: 'The standard Sune: One corner oriented, others cycle clockwise.',
      isFree: true,
    ),
    AlgCase(
      id: 'oll27',
      ...
      description: 'The Anti-Sune: One corner oriented, others cycle counter-clockwise.',
      isFree: true,
    ),
